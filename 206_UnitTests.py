...
# People you worked with: Did not have time to start homework in discussion
...
class TestCard(unittest.TestCase): 
	...
	def test_suit_names(self):
		example_card = Card()
		self.assertEqual(example_card.suit_names, ["Diamonds","Clubs","Hearts","Spades"])
	...
	def test_pop_method(self):
		card_instance = Card()
		deck = Deck()
		self.assertEqual(type(deck.pop_card()), type(card_instance))
	...
	def test_faces(self):
		y = Card()
		self.assertEqual(y.faces, {1:"Ace",11:"Jack",12:"Queen",13:"King"}) 
		# Testing that if you create a card instance, it will have access to a variable faces, which returns the dictionary of rankings and their
		# corresponding face. 

	def test_shuffle(self):
		test_deck = Deck()
		shuffled_deck = test_deck.shuffle()
		self.assertNotEqual(test_deck, shuffled_deck)
		# Testing that if you create a deck instance and then shuffle it, the new deck will not match the original one. 
